...
export const HEALTH_IMPORT_PROVIDERS = [
    {
        ...
        "setup_lines": GOOGLE_HEALTH_CLIENT_ID ? [] : [
            ...
            "https://sleepdiary.github.io",
        ],
        "scope_note": "Sleep Diary requests only the " + get_google_health_scope() + " scope, and your Google Health data stays in your browser.",
    ...
    },
    {
        ...
        "scope_note": "Sleep Diary only requests the sleep scope, and your Fitbit data stays in your browser. Fitbit Web API is a legacy path scheduled for deprecation in September 2026.",
